...
```
![[ ../../snippets/pandoc-flavored-markdown/setext-style-headings.md ]]
```
...
```
![[ ../../snippets/pandoc-flavored-markdown/atx-style-headings.md ]]
```
...
```
![[ ../../snippets/pandoc-flavored-markdown/blank_before_header.md ]]
```
...
```
![[ ../../snippets/pandoc-flavored-markdown/space_in_atx_header.md ]]
```
...
```
![[ ../../snippets/pandoc-flavored-markdown/header_attributes.md ]]
```
...
```
![[ ../../snippets/pandoc-flavored-markdown/implicit_header_references.md ]]
```
